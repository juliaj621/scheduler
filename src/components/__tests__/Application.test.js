...
describe("Application", () => {
  ...
  // 5. Enter edited name "whatever" into the input with the placeholder "Enter Student Name".
    fireEvent.change(getByPlaceholderText(appointment, /enter student name/i), {
      target: { value: "New Student!!" }
    });
  // 5. Click a different interviewer using the interviewers_item class.
    fireEvent.click(getByAltText(appointment, "Sylvia Palmer"));
  ...
  // 7. Wait until the element with the new text is displayed
    await waitForElement(() => getByText(container, "New Student!!"));
